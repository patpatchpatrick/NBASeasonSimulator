...
public class SimulatorModel implements SimulatorMvpContract.SimulatorModel {
    ...
    public void createTeamLogoMap() {
        ...
        teamLogos.put(NFLConstants.TEAM_ATLANTA_HAWKS_STRING, R.drawable.arizonacardinals);
        teamLogos.put(NFLConstants.TEAM_BOSTON_CELTICS_STRING, R.drawable.atlantafalcons);
        teamLogos.put(NFLConstants.TEAM_BROOKLYN_NETS_STRING, R.drawable.baltimoreravens);
        teamLogos.put(NFLConstants.TEAM_CHARLOTTE_HORNETS_STRING, R.drawable.buffalobills);
        teamLogos.put(NFLConstants.TEAM_CHICAGO_BULLS_STRING, R.drawable.carolinapanthers);
        teamLogos.put(NFLConstants.TEAM_CLEVELAND_CAVALIERS_STRING, R.drawable.chicagobears);
        teamLogos.put(NFLConstants.TEAM_DALLAS_MAVERICKS_STRING, R.drawable.cincinnatibengals);
        teamLogos.put(NFLConstants.TEAM_DENVER_NUGGETS_STRING, R.drawable.clevelandbrowns);
        teamLogos.put(NFLConstants.TEAM_DETROIT_PISTONS_STRING, R.drawable.dallascowboys);
        teamLogos.put(NFLConstants.TEAM_GOLDENSTATE_WARRIORS_STRING, R.drawable.denverbroncos);
        teamLogos.put(NFLConstants.TEAM_HOUSTON_ROCKETS_STRING, R.drawable.detroitlions);
        teamLogos.put(NFLConstants.TEAM_INDIANA_PACERS_STRING, R.drawable.greenbaypackers);
        teamLogos.put(NFLConstants.TEAM_LOSANGELES_CLIPPERS_STRING, R.drawable.houstontexans);
        teamLogos.put(NFLConstants.TEAM_LOSANGELES_LAKERS_STRING, R.drawable.indianapoliscolts);
        teamLogos.put(NFLConstants.TEAM_MEMPHIS_GRIZZLIES_STRING, R.drawable.jacksonvillejaguars);
        teamLogos.put(NFLConstants.TEAM_MIAMI_HEAT_STRING, R.drawable.kansascitychiefs);
        teamLogos.put(NFLConstants.TEAM_MILWAUKEE_BUCKS_STRING, R.drawable.losangeleschargers);
        teamLogos.put(NFLConstants.TEAM_MINNESOTA_TIMBERWOLVES_STRING, R.drawable.losangelesrams);
        teamLogos.put(NFLConstants.TEAM_NEWORLEANS_PELICANS_STRING, R.drawable.miamidolphins);
        teamLogos.put(NFLConstants.TEAM_NEWYORK_KNICKS_STRING, R.drawable.minnesotavikings);
        teamLogos.put(NFLConstants.TEAM_OKLAHOMACITY_THUNDER_STRING, R.drawable.newenglandpatriots);
        teamLogos.put(NFLConstants.TEAM_ORLANDO_MAGIC_STRING, R.drawable.neworleanssaints);
        teamLogos.put(NFLConstants.TEAM_PHILADELPHIA_76ERS_STRING, R.drawable.newyorkgiants);
        teamLogos.put(NFLConstants.TEAM_PHOENIX_SUNS_STRING, R.drawable.newyorkjets);
        teamLogos.put(NFLConstants.TEAM_PORTLAND_TRAILBLAZERS_STRING, R.drawable.oaklandraiders);
        teamLogos.put(NFLConstants.TEAM_SACRAMENTO_KINGS_STRING, R.drawable.philadelphiaeagles);
        teamLogos.put(NFLConstants.TEAM_SANANTONIO_SPURS_STRING, R.drawable.pittsburghsteelers);
        teamLogos.put(NFLConstants.TEAM_TORONTO_RAPTORS_STRING, R.drawable.sanfrancisco49ers);
        teamLogos.put(NFLConstants.TEAM_UTAH_JAZZ_STRING, R.drawable.seattleseahawks);
        teamLogos.put(NFLConstants.TEAM_WASHINGTON_WIZARDS_STRING, R.drawable.tampabaybuccaneers);
