...
public class SimulatorModel implements SimulatorMvpContract.SimulatorModel {
    ...
    public void createTeamLogoMap() {
        ...
        teamLogos.put(NBAConstants.TEAM_ATLANTA_HAWKS_STRING, R.drawable.arizonacardinals);
        teamLogos.put(NBAConstants.TEAM_BOSTON_CELTICS_STRING, R.drawable.atlantafalcons);
        teamLogos.put(NBAConstants.TEAM_BROOKLYN_NETS_STRING, R.drawable.baltimoreravens);
        teamLogos.put(NBAConstants.TEAM_CHARLOTTE_HORNETS_STRING, R.drawable.buffalobills);
        teamLogos.put(NBAConstants.TEAM_CHICAGO_BULLS_STRING, R.drawable.carolinapanthers);
        teamLogos.put(NBAConstants.TEAM_CLEVELAND_CAVALIERS_STRING, R.drawable.chicagobears);
        teamLogos.put(NBAConstants.TEAM_DALLAS_MAVERICKS_STRING, R.drawable.cincinnatibengals);
        teamLogos.put(NBAConstants.TEAM_DENVER_NUGGETS_STRING, R.drawable.clevelandbrowns);
        teamLogos.put(NBAConstants.TEAM_DETROIT_PISTONS_STRING, R.drawable.dallascowboys);
        teamLogos.put(NBAConstants.TEAM_GOLDENSTATE_WARRIORS_STRING, R.drawable.denverbroncos);
        teamLogos.put(NBAConstants.TEAM_HOUSTON_ROCKETS_STRING, R.drawable.detroitlions);
        teamLogos.put(NBAConstants.TEAM_INDIANA_PACERS_STRING, R.drawable.greenbaypackers);
        teamLogos.put(NBAConstants.TEAM_LOSANGELES_CLIPPERS_STRING, R.drawable.houstontexans);
        teamLogos.put(NBAConstants.TEAM_LOSANGELES_LAKERS_STRING, R.drawable.indianapoliscolts);
        teamLogos.put(NBAConstants.TEAM_MEMPHIS_GRIZZLIES_STRING, R.drawable.jacksonvillejaguars);
        teamLogos.put(NBAConstants.TEAM_MIAMI_HEAT_STRING, R.drawable.kansascitychiefs);
        teamLogos.put(NBAConstants.TEAM_MILWAUKEE_BUCKS_STRING, R.drawable.losangeleschargers);
        teamLogos.put(NBAConstants.TEAM_MINNESOTA_TIMBERWOLVES_STRING, R.drawable.losangelesrams);
        teamLogos.put(NBAConstants.TEAM_NEWORLEANS_PELICANS_STRING, R.drawable.miamidolphins);
        teamLogos.put(NBAConstants.TEAM_NEWYORK_KNICKS_STRING, R.drawable.minnesotavikings);
        teamLogos.put(NBAConstants.TEAM_OKLAHOMACITY_THUNDER_STRING, R.drawable.newenglandpatriots);
        teamLogos.put(NBAConstants.TEAM_ORLANDO_MAGIC_STRING, R.drawable.neworleanssaints);
        teamLogos.put(NBAConstants.TEAM_PHILADELPHIA_76ERS_STRING, R.drawable.newyorkgiants);
        teamLogos.put(NBAConstants.TEAM_PHOENIX_SUNS_STRING, R.drawable.newyorkjets);
        teamLogos.put(NBAConstants.TEAM_PORTLAND_TRAILBLAZERS_STRING, R.drawable.oaklandraiders);
        teamLogos.put(NBAConstants.TEAM_SACRAMENTO_KINGS_STRING, R.drawable.philadelphiaeagles);
        teamLogos.put(NBAConstants.TEAM_SANANTONIO_SPURS_STRING, R.drawable.pittsburghsteelers);
        teamLogos.put(NBAConstants.TEAM_TORONTO_RAPTORS_STRING, R.drawable.sanfrancisco49ers);
        teamLogos.put(NBAConstants.TEAM_UTAH_JAZZ_STRING, R.drawable.seattleseahawks);
        teamLogos.put(NBAConstants.TEAM_WASHINGTON_WIZARDS_STRING, R.drawable.tampabaybuccaneers);
        teamLogos.put(NBAConstants.TEAM_TENNESSEE_TITANS_STRING, R.drawable.tennesseetitans);
        teamLogos.put(NBAConstants.TEAM_WASHINGTON_REDSKINS_STRING, R.drawable.washingtonredskins);
